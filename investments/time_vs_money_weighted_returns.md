...
### $|C_0| + \sum_{n\in\lbrace\text{deposits}\rbrace} \frac{|C_n|}{\left( 1 + r \right)^{t_n}} - \sum_{m\in\lbrace\text{withdrawals}\rbrace} \frac{|C_m|}{\left( 1 + r \right)^{t_m}} = \frac{|C_N|}{\left( 1 + r \right)^{t_N}}  \qquad .$  
